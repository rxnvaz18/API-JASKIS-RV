...
// use jaskis
// db (to check if successful)
// 2. Create a collection called bounties
// db.createCollection('bounties')
// success check : show collections
...
// did this in previous step since error code is thrown when only one is input
// MANAGE THE DATABASE
// Queries
...
// db.bounties.find({species:"Groundhog",location:"Grasslands"})
// Update and Delete
